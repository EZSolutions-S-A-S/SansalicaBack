...
SIMPLE_JWT = {
    ...
    # Sin esto, rotar el refresh token era solo cosmético: el token viejo
    # seguía siendo válido aunque ya no lo usaras. Con esto, cada rotación
    # invalida de verdad el anterior — y el logout usa el mismo mecanismo.
